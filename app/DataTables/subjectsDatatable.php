    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($item){
                $btn = ' <a href="'.route('admin.subjects.edit',$item->id).'" class="btn btn-xs btn-info"><i class="fa fa-pencil-alt"></i></a>';
                $btn .= '<form  action="'. route('admin.subjects.destroy',$item->id).'" method="POST" class="d-inline" >
