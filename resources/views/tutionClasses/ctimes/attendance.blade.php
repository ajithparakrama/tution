...
<div class="container-fluid">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
             <h4>Attendance  {{ $ctime->date.'  from '.$ctime->start_at.'  to '.$ctime->end_at }} </h4>
            </div>
            <div class="col-sm-6">
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">{{ $tution->name }} </h2>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="input-group input-group-lg">
                            <input type="text" class="form-control @error('student_id') is-invalid @enderror" name="student_id" id=""  >
                            @error('students_id')
        ...
        <div class="card-footer">
            <input type="submit" value="In" class="btn btn-sm btn-success">
        </div>
    </form>
    </div>
</div>
