                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Date and time</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <form action="{{ route('ctimes.update',[$tution->id,$ctime->id]) }}" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="input-group date @error('date') is-invalid @enderror" id="date" data-target-input="nearest">
                            <input type="text" class="form-control @error('date') is-invalid @enderror"   name="date" data-toggle="datetimepicker"  value="{{ $ctime->date }}"data-target="#date">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2"> 
                              <div class="input-group date @error('start_at') is-invalid @enderror" id="start_at" data-target-input="nearest">
                                <input type="text" class="form-control @error('start_at') is-invalid @enderror"  name="start_at" data-toggle="datetimepicker"  value="{{ $ctime->start_at }}"data-target="#start_at">
                      ...
                      <div class="col-sm-2">
                            ...
                            <div class="input-group date @error('end_at') is-invalid @enderror" id="end_at" data-target-input="nearest">
                              <input type="text" class="form-control @error('end_at') is-invalid @enderror"  name="end_at" data-toggle="datetimepicker"  value="{{ $ctime->end_at }}"data-target="#end_at">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <textarea name="remarks" id="" cols="30" rows="3" class="form-control os-textarea">{{ $ctime->remarks }}</textarea>
